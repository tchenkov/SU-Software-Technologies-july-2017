...
public class HomeController {
	...
	public String calculate(
		...
		model.addAttribute("leftOperand", calculator.spellCaster(calculator.getLeftOperand()));
		model.addAttribute("rightOperand", calculator.spellCaster(calculator.getRightOperand()));
		model.addAttribute("operator", calculator.getOperator());
		model.addAttribute("result", calculator.spellCaster(result));
